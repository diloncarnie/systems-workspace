...
{
public:
    Updater(const rclcpp::Node::SharedPtr& node);
...
private:
    ...
    std_msgs::msg::ColorRGBA colorLandmark_po;
    std_msgs::msg::ColorRGBA colorLandmark_is;
    std_msgs::msg::ColorRGBA colorLandmark_ex;
};
